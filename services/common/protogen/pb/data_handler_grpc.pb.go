...
func (UnimplementedDataHandlerServer) GetLastUpdates(context.Context, *LastUpdatesRequest) (*MediaListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLastUpdates not implemented")
}
func (UnimplementedDataHandlerServer) GetOneMedia(context.Context, *MediaRequest) (*Media, error) {
	return nil, status.Error(codes.Unimplemented, "method GetOneMedia not implemented")
}
func (UnimplementedDataHandlerServer) GetMediaFiltered(context.Context, *MediaFilteredRequest) (*MediaListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMediaFiltered not implemented")
}
...
func (UnimplementedDataHandlerServer) UpdateMediaBooleans(context.Context, *MediaUpdateBool) (*MediaResume, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateMediaBooleans not implemented")
}
func (UnimplementedDataHandlerServer) GetMediaCount(context.Context, *EmptyMsg) (*MediaCount, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMediaCount not implemented")
}
...
func RegisterDataHandlerServer(s grpc.ServiceRegistrar, srv DataHandlerServer) {
	// If the following call panics, it indicates UnimplementedDataHandlerServer was
